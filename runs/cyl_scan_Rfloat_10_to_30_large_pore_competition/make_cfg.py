...
def get_basic_config():
    ...
    config.interaction_range.lower=2
...
def add_kaps(fg_name,
    ...
    for radius in [15, 20, 25]:
        type_name="kap%d" % radius
        kaps.append(IMP.npctransport.add_float_type(config,
                                                 number=50,
                                                 radius=radius,
                                                 interactions=12,
                                                 type_name=type_name ) )
...
# fg with kaps / craps
kaps=add_kaps("fg0", k_kap_lower=5.0)

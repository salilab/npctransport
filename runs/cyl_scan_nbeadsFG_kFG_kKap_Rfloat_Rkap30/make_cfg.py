...
fg_middle= IMP.npctransport.add_fg_type(config,
                                 ...
                                 interactions=1,
                                 rest_length_factor = 1.5)
create_range(fg_middle.number_of_beads,5,20,4)
...
# fg with kaps / craps
add_interactions_for_fg("fg0", 1, 15, k_kap_steps = 7, k_kap_base=1)
...
interactionFG_FG= IMP.npctransport.add_interaction(config,
                                                   ...
                                                   interaction_k=0,
                                                   interaction_range= 2)
create_range(interactionFG_FG.interaction_k, lb = 1, ub = 15, steps = 7, base = 1)
## internal FG-FG
#for i in range(3):
#    for j in range(i,3):
#        interactionFG_FG= IMP.npctransport.add_interaction(config,

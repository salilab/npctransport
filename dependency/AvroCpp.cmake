...
if ("${AvroCpp_LIBRARY}" MATCHES ".*NOTFOUND.*"
  ...
  check_compiles("_found" "AvroCpp" "AVROCPP" "#include <ValidSchema.hh>" "${AVROCPP_INCLUDE_PATH}"/avro "${AvroCpp_LIBRARY}" AvroCpp_ok_ok)
  if(${AvroCpp_ok_ok} MATCHES "1")
    message(STATUS "Found AvroCpp at ""${AVROCPP_INCLUDE_PATH}" " " "${AvroCpp_LIBRARY}")
    set("AVROCPP_INCLUDE_PATH" ${AvroCpp_INCLUDE_DIR}/avro CACHE STRING "Location of avro headers" FORCE)
    set("AVROCPP_LIBRARIES" "${AvroCpp_LIBRARY}" CACHE STRING "Avro libraries" FORCE)
  else()
    set(AVROCPP_INTERNAL 1 CACHE INTERNAL "" FORCE)
  endif()
endif()

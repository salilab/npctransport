...
create_range(config.slab_thickness, lb=100, ub=200, steps=11, base =1)
create_range(config.tunnel_radius, lb=60, ub=120, steps=7, base =1)
...
# fg with kaps / craps
add_interactions_for_fg("fg0", 3.5, 6.5, k_kap_steps = 5, k_kap_base=1)
...
interactionFG_FG= IMP.npctransport.add_interaction(config,
                                                   ...
                                                   interaction_k=0,
                                                   interaction_range= 2)
create_range(interactionFG_FG.interaction_k, lb = 1, ub = 3.5, steps = 5, base = 1)
## internal FG-FG
#for i in range(3):
#    for j in range(i,3):
#        interactionFG_FG= IMP.npctransport.add_interaction(config,

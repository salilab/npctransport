...
max_y=0
max_z=0
mean_loc=(add_fg_based_on(config, mrc_filename=None, k=10, nfgs=20, nres=125, scale_tunnel=scale_tunnel))
...
config.box_side.lower=1000 # max(max_z,max_x,max_y)*3.5 # 2000

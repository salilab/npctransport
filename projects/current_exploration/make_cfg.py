...
config.fgs[-1].interaction_k_factor.lower=3.0 ##### IMPORTANT #######
...
nonspecifics= IMP.npctransport.add_float_type(config,
                                              ...
                                              radius=kaps_R, #-1,
                                              interactions=0)
nonspecifics.k_z_bias.lower=0.05
nonspecifics.k_z_bias_fraction.lower=1.0

...
conda create --yes -q -n python${python_version} -c salilab -c conda-forge python=${python_version} numpy pip imp-nightly libboost-devel gxx_linux-64 eigen cereal swig==4.3 cmake protobuf

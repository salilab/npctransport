 ...
 */
struct IMPNPCTRANSPORTEXPORT SitesPairScoreParams {
  double r; // range
   ...
   */
  SitesPairScoreParams(double range, double k_coefficient, double sigma1_max_deg=0.0, double sigma2_max_deg=0.0)
  { 
    set_range(range);
 ...
 public:
    IMP_SHOWABLE_INLINE(SitesPairScoreParams, 
...
IMP_VALUES(SitesPairScoreParams,SitesPairScoreParamsList);
